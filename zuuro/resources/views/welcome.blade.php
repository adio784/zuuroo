...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Home ::| - Welcome to Zuuro Telecommunications Limited</title>
                ...
                <div class="row">
                  <div class="col-lg-6 align-self-center">
                    <div class="header-text">
                      ...
                      <h2>where distance is not a barrier to reaching out to your loved ones around the <em> world!</em></h2>
                      <div class="main-button-gradient">
                        <div class="scroll-to-section"><a href="/register ">Sign Up Now</a></div>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                ...
                <div class="row">
                  <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                      <h6>OUR CORE COMPETENCY</h6>
                      <h4>What You Stand To <em>Enjoy</em></h4>
                      <p>From anywhere in the world, you can put beautiful smiles on your loved ones' faces by helping them stay connected every time!  </p>
                    </div>
                  </div>
                  <div class="col-lg-12">
                    <div class="naccs">
                              ...
                              <li class="active">
                                <div>
                                  ...
                                  <div class="right-content">
                                    <h4> Mobile Recharge Services </h4>
                                    <p>With our Mobile Recharge Services available in over 150 countries and 850+ mobile networks, we are a tested, trusted, and reliable means of purchasing mobile top-ups online. We are fast, convenient, affordable, and user-friendly.</p>
                                    <span>Fast</span>
                                    <span>Secure</span>
                                    <span class="last-span">Relaible</span>
                                    <br> <br>
                                    <!-- <div class="text-button"> -->
                                      <div class="main-button-gradient">
                                        <div class="scroll-to-section"><a href="/register ">Sign Up Now</a></div>
                                      </div>
                                      <!-- <a href="/register">Signup with us</a> -->
                                    <!-- </div> -->
                                  </div>
                                </div>
                              </li>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="section-heading">
                      ...
                      <h4>Why choose our <em>Service?</em></h4>
                    </div>
                  </div>
                  <div class="col-lg-3 align-self-center">
                    <div class="left-info">
                      <div class="col-lg-12">
                        <div class="info-item">
                          <div class="icon">
                            <img src="{{ asset('images/customer-support.png') }}" alt="">
                          </div>
                          <h4>Customer Support</h4>
                          <p>Our customer support are available 24/7 to look into challenges and issue.</p>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="info-item last-info">
                          <div class="icon">
                            <img src="{{ asset('images/secure-reliable.png') }}" alt="">
                          </div>
                          <h4>Secure & Reliable</h4>
                          <p>We treat customer information secure without exposing to third party.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="product-image">
                      <img src="{{ asset('images/featured-product.png') }}" alt="">
                    </div>
                  </div>
                  <div class="col-lg-3 align-self-center">
                    <div class="right-info">
                      <div class="col-lg-12">
                        <div class="info-item">
                          ...
                          <h4>Fast / Automated Service</h4>
                          <p>Wallet funding and other services are automated and faster.</p>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="info-item last-info">
                          <div class="icon">
                            <img src="{{ asset('images/e-wallet.png') }}" alt="">
                          </div>
                          <h4>E-wallet System</h4>
                          <p>We operate an e-wallet system which is the safest, easiest and fastest means of carrying out transactions with us.</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-12">
                    <div class="section-heading">
                      <h6>Promotions</h6>
                      <h4>Latest Offer From <em>Us</em></h4>
                    </div>
                  </div>
                  <div class="col-lg-12">
