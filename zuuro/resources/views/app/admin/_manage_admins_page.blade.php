                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#modalCenter{{ $user->id }}" onclick="return confirm('Are you sure to changes this user's password?')">
