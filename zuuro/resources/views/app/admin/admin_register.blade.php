...
<html
  ...
  data-assets-path="http://127.0.0.1:8000//"
...
>
  <head>
    ...
    <title>Zuuro - Admin | Welcome - perform administrative functionalities here</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-0">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Zuuro Telecomms</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">All operations start here 🚀</h4>
              <p class="mb-4">Make your app management easy and fun!</p>

              <form class="mb-3" action="{{ route('admin_register') }}" method="post">
              @csrf
                <!-- Result  -->
                <div id="result">
              ...
              <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  @error('number') <span class="text-danger text-sm"> {{ $message }}  </span>@enderror
                </div>
