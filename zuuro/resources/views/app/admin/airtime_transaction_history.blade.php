...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaction History /</span> Airtime</h4>
        ...
        <div class="row">
          <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="/fund_transaction_history"
                                  ...
                                  <td>
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu">
                                        <a class="dropdown-item" href="/transaction_receipt/{{ $item->transfer_ref }}"
