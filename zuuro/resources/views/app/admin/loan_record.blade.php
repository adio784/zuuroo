...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Loan Management /</span> Loan Record</h4>

        <div class="row">
          <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                <li class="nav-item">
                    <a class="nav-link " href="/paid_loan">
                      <i class="bx bx-user me-1"></i> Paid Loan</a>
                </li>
                {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="javascript:void(0);"
                    ><i class="bx bx-link-alt me-1"></i> Loan Record</a
                  >
                </li>
              </ul>
                      ...
                      <div class="col-4 mb-4">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <span class="d-block mb-1"> Due Loan </span>
                            <h3 class="card-title text-nowrap mb-2">₦{{ $DueLoan }}</h3>
                            <small class="text-danger fw-semibold"><i class="bx bx-down-arrow-alt"></i> @if($DueLoan ==0) {{ '0' }} @else {{ round($DueLoan/$TotalLoan * 100 , 2) }}% @endif</small>
                          </div>
                        </div>
                      </div>
                      {{-- Due Loan Ends Here --}}
                      ...
                      <div class="col-4 mb-4">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <span class="d-block mb-1"> Paid Loan</span>
                            <h3 class="card-title text-nowrap mb-2">₦{{ $TotalPaid }}</h3>
                            <small class="text-danger fw-semibold"><i class="bx bx-up-arrow-alt"></i> @if($TotalPaid==0){{ '0' }} @else{{ round($TotalPaid/$TotalLoan * 100, 2) }}% @endif</small>
                          </div>
                        </div>
                      </div>
                      {{-- Total Paid --}}
