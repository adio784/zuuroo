...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @endif
    @if (Auth::user()->country == 'NG' && Auth::user()->country_verify_at == '')
        <div class="alert alert-danger text-danger alert-dismissible fade show" role="alert">
            <a href="{{ route('country') }}">
                {{--  --}}
                <strong class="text-danger">Attention !!! </strong> Kindly Verify Your Country to be able to use some of our special features ...
            </a>
        </div>
    @endif
    ...
    <div class="col-lg-4 col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title mb-2">{{ number_format($wallet->balance) }} @if(Auth::user()->country == 'NG') {{ 'NGN' }} @else {{ 'USD' }}  @endif </h4>
            </div>
        </div>
    ...
    <div class="col-md-12 col-lg-12 order-2 mb-4">
        ...
        <div class="card-body">
            ...
            <li class="d-flex">
                ...
                <div class="user-progress d-flex align-items-center gap-1">
                    <h6 class="mb-0">{{ number_format( $TotalFund->sum('amount') ) }} </h6>
                    <span class="text-muted">@if(Auth::user()->country == 'NG') {{ 'NGN' }} @else {{ 'USD' }} @endif </span>
                </div>
                </div>
            </li>
...
<div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
    ...
    <!--<a href="https://chatwith.io/s/kettlesub-telecommunication" class="float" target="_blank">-->
...
@endsection
    ...
    <script  type="text/javascript">
      var config = {
        phone :" 234 801 895 9289",
        call :"Message Us",
        position :"ww-right",
        size : "ww-normal",
        text : "",
        type: "ww-standard",
        brand: "Zuuroo Telecomm.",
        subtitle: "",
        welcome: ""
      };
